...
$SourceDir = "C:\Users\RalphMccabe\.gemini\antigravity\scratch\TacticalRangeCard-Sandbox"
...
$IndexContent = [regex]::Replace($IndexContent, "window\.APP_VERSION\s*=\s*'v[\d.]+'", "window.APP_VERSION = '$NewVersion'")
...
$Exclusions = @(
    ...
    "live_index.html", "live_trc_core.js",
    # Dev-only scripts — never go to production
    "fix_a11y.py", "generate_cert.py", "cleanup.ps1", "run_backup.ps1",
    "backup_to_usb.ps1", "test.js", "serve.ps1"
)
